...
import { ModalForm, ProFormText, ProFormList, ProFormGroup } from '@ant-design/pro-form';
...
import {
  ...
  removeProcess,
  Process,
} from '@/services/ant-design-pro/process';
import UpdateForm from '@/pages/shop/process/components/UpdateForm';
